...
// ==============================================================
#ifndef __conv_mac_muladd_5bkb__HH__
#define __conv_mac_muladd_5bkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mac_muladd_5bkb) {
    ...
    SC_CTOR(conv_mac_muladd_5bkb):  simcore_mac_0_U ("simcore_mac_0_U") {
